                                ...
                                function createCalendar(date, side) {
                                    ...
                                    setTimeout(() => {
                                        ...
                                        for (let i = 0; i < (startDate.getDay() || 7); i++) {
                                        ...
                                        for (let i = 1; i <= lastDay; i++) {
                                            ...
                                            if (todayDate > new Date(currentDate.getFullYear(), currentDate.getMonth(), i) || new Date(currentDate.getFullYear(), currentDate.getMonth(), i).getDay() == 0 || new Date(currentDate.getFullYear(), currentDate.getMonth(), i).getDay() == 6) {
                                                selectedDayBlock = currentDay;
                                                setTimeout(() => {
                                                    currentDay.style.pointerEvents = "none";
                                                    if (i == currentDate.getDate()) {
                                                        console.log(currentDate);
                                                        currentDay.classList.add("grey");
                                                    } else {
                                                        currentDay.classList.add("blocked");
                                                    }
                                                }, 900);
                                            }
                                            ...
                                            currentDay.innerHTML = padWithLeadingZeros(i, 2);
                                ...
                                gridTable.onclick = function(e) {
                                    ...
                                    selectedDate = new Date(currentDate.getFullYear(), currentDate.getMonth(), parseInt(e.target.innerHTML));
                                    var selectedDateFormat = moment(selectedDate).format('YYYY-MM-DD');

                                    $("#selectedDateFormat").val(selectedDateFormat);

                                    $("#continueBtn").show();


                                    console.log(e.target, e, $(e.target).closest('.row'), selectedDate);

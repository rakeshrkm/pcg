        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="card business-choose shadow">
                    ...
                    <p class="text-center">Our personalised approach guarantees that fresh graduates are ready to drive organisational success.</p>
                </div>
            ...
            <div class="col-md-3">
                <div class="card business-choose shadow">
                    ...
                    <p class="text-center">Pre-screening ensures only the most qualified candidates reach your team.</p>
                </div>
            ...
            <div class="col-md-3">
                <div class="card business-choose shadow">
                    ...
                    <p class="text-center">Collaborations with top colleges give access to diverse, high-potential talent pools.</p>
                </div>
            </div>
...
<section class="section" style="background-image: linear-gradient(to right, rgb(9, 129, 120), rgb(31, 58, 87));">
    <div class="container">
        <div class="row py-2">
            <div class="col-md-12">
                <div class="text-center heading-title1">
                    <h3 class="text-white">What Makes Us Your Trusted Staffing Partner?</h3>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="p-2 card business-choose shadow">
                    <div class="text-center ">
                        <img class="w-25 mt-2" src="{{ asset('assets/img/PCGImages/home/Customized-Workforce-Solutions.png') }}" title="Customized Workforce Solutions" alt="Customized Workforce Solutions">
                    </div>
            ...
            <div class="col-md-3">
                <div class="p-2 card business-choose shadow">
                    <div class="text-center ">
                        <img class="w-25 mt-2" src="{{ asset('assets/img/PCGImages/home/Comprehensive-Talent-Pool.png') }}" title="Comprehensive Talent Pool" alt="Comprehensive Talent Pool">
                    </div>
            ...
            <div class="col-md-3">
                <div class="p-2 card business-choose shadow">
                    <div class="text-center heading_background2">
                        <img class="w-25 mt-2" src="{{ asset('assets/img/PCGImages/home/Efficient-Recruitment-Process.png') }}" title="Efficient Recruitment Process" alt="Efficient Recruitment Process">
                    </div>
            ...
            <div class="col-md-3">
                <div class="p-2 card business-choose shadow">
                    <div class="text-center heading_background">
                        <img class="w-25 mt-2" src="{{ asset('assets/img/PCGImages/home/Enhanced-Productivity.png') }}" title="Enhanced Productivity" alt="Enhanced Productivity">
                    </div>
        ...
        <div class="row ctabutton mt-4">
            <div class="col-md-12">
                <div class="text-center mt-4">
                    <button type="button" class="btn btn-default bg-white custom_button" data-toggle="modal" data-target="#exampleModalCenter">
                        <span class="text-white text-dark">Request Staffing Solutions</span>
                    </button>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="d-flex">
                    <div class="text-center">
                        <img class="w-75" src="{{ asset('assets/img/PCGImages/home/End-to-End-Recruitment.png') }}" title="Customised Approach" alt="Customised Approach">
                    </div>
                    <div>
                        <p class="ml-1"><span class="whatwedotitile">End-to-End Recruitment Solutions:</span> From talent sourcing and screening to onboarding.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="d-flex justify-content-center">
                    <div class="text-center">
                        <img class="w-75" src="{{ asset('assets/img/PCGImages/home/Customised-Approach.png') }}" title="Customised Approach" alt="Customised Approach">
                    </div>
                    <div>
                        <p class="ml-2"><span class="whatwedotitile">Customised Approach:</span> Recruitment strategies aligned with your unique organisational needs.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="d-flex justify-content-center">
                    <div class="text-center">
                        <img class="w-75" src="{{ asset('assets/img/PCGImages/home/Industry-Specific-Expertise.png') }}" title="Industry-Specific Expertise" alt="Industry-Specific Expertise">
                    </div>
                    <div>
                        <p class="ml-2"><span class="whatwedotitile">Industry-Specific Expertise:</span> Proven success in diverse sectors, ensuring a perfect fit for your team.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="d-flex justify-content-center">
                    <div class="text-center">
                        <img class="w-75" src="{{ asset('assets/img/PCGImages/home/Resource-Efficiency.png') }}" title="Resource Efficiency" alt="Resource Efficiency">
                    </div>
                    <div>
            ...
            <div class="col-md-6">
                <div class="d-flex justify-content-center">
                    <div class="text-center">
                        <img class="w-75" src="{{ asset('assets/img/PCGImages/home/Collaborative-Partnership.png') }}" title="Collaborative Partnership" alt="Collaborative Partnership">
                    </div>
                    <div>
                        <p class="ml-2"><span class="whatwedotitile">Collaborative Partnership:</span> We work closely with you to exceed expectations and deliver measurable results.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="flip-card  mt-4">
                    <div class="flip-card-inner">
                        ...
                        <div class="flip-card-back p-4">
                            <p class="whatwedotitile mt-4 center">Permanent Staffing</p>

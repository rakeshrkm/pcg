...
<main class="wrapper">
  ...
  <section class="container">
   ...
   <div class="row align-items-center">
    <div class="col-md-6">
        <p>As digital learning grows, so does the demand for professionals skilled in curriculum design, e-learning platforms, and AI-based learning tools. We help organisations build teams that enhance education for a digital age.</p>
    </div>
    <div class="col-md-6">
...
<section class="container">
    ...
    <div class="row align-items-center">
     ...
     <div class="col-md-6">
        <p>From addressing workforce shortages to managing automation, we connect businesses with skilled professionals who ensure operational efficiency and adapt to advancements in manufacturing technology.</p>
     </div>
 </section>

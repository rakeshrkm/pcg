...
<main class="wrapper">
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-12">
                    ...
                    <p>Through our <span class="whatwedotitile">Internal Hiring Support Services</span>, we streamline staff recruitment for various roles and offer <span class="whatwedotitile">Contract & Temporary Staffing</span> options, ensuring flexibility and efficiency for educational institutions. </p>
                    <p>We run <span class="whatwedotitile">Student Development Programs</span> to prepare students for professional success, bridging the gap between academia and industry. </p>
                    <p>With a commitment to quality, compliance, and tailored HR solutions, Prakhar Consulting Group empowers universities to build a competent and resilient workforce.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="container">
        <div class="text-center">
            ...
            <div class="row">
                <div class="col-md-12">
                    <p>The <span class="whatwedotitile">Campus-to-Corporate Program</span> is designed to equip students with essential skills for a successful transition into the corporate world. </p>
                    <p>Through <span class="whatwedotitile">Career Readiness Training<span class="whatwedotitile"> and <span class="whatwedotitile">Skill Development & Career Prep<span class="whatwedotitile">, we provide tailored guidance that enhances students’ professional competencies. </p>
                    <p>Our program connects students to <span class="whatwedotitile">Placement & Job Opportunities</span>, preparing them to excel in real-world work environments. </p>
                    <p>Prakhar Consulting Group empowers young professionals with the tools and confidence needed for a thriving career.</p>
                </div>
            </div>
    </section>

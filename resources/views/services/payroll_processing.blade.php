    ...
    <section>
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-12">
                    <h1 class="text-center mt-4 p-4 ">PCG: One of the Top-Grade Payroll Processing Companies India</h1>
                </div>
                <div class="col-md-12">
                    <p>Prakhar Consulting Group, one of the best <span class="whatwedotitile">Payroll Processing Companies in India</span>, understands that managing payroll is a critical yet time-consuming function for any organization. </p>
                    <p>Therefore, our <span class="whatwedotitile">Payroll Outsourcing Services</span> are designed to streamline and simplify this process, enabling companies to focus on their core business activities. </p>
                    <p>By choosing us, businesses can benefit from a smooth, accurate, and compliant payroll system that minimizes administrative burdens and ensures that employees are paid on time, every time.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="container">
        <div class="heading-title text-center">
            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="mb-4 mt-4">
                        <p>Our <span class="whatwedotitile">Payroll Services</span> cover every aspect of payroll management, from salary calculations and tax deductions to compliance with labor laws and regulatory requirements. </p>
                        <p>With a robust payroll system in place, we ensure that your payroll data remains secure, accessible, and efficiently managed. </p>
                        <p>By outsourcing payroll functions, businesses can also reduce operational costs, mitigate risks of payroll errors, and maintain strict compliance with constantly evolving payroll legislation.</p>
                    </ul>
                    <p>We leverage cutting-edge technology and experienced payroll professionals to provide customized solutions that meet the unique needs of each client. </p>

        ...
        <div class="row">
            <div class="col-md-12">
                <div class="d-flex justify-content-center gap-8">
                    <div class="text-center">
                        <img class="w-75" src="{{ asset('assets/img/PCGImages/leadership-hiring/Advanced-Leadership-Assessmen.jpg') }}" title="Advanced Leadership Assessment"  alt="Advanced Leadership Assessment">
                    </div>
            ...
            <div class="col-md-12">
                <div class="d-flex justify-content-center gap-8">
                    <div>
                        <img class="w-75" src="{{ asset('assets/img/PCGImages/leadership-hiring/Access-to-Hidden-Talent.jpg') }}" title="Access to Hidden Talent"  alt="Access to Hidden Talent">
                    </div>
                    <div class="ml-3">
            ...
            <div class="col-md-12">
                <div class="d-flex justify-content-center gap-8">
                    <div>
                        <img class="w-75" src="{{ asset('assets/img/PCGImages/leadership-hiring/Cultural-Fit-and-Immediate-Results.jpg') }}" title="Cultural Fit and Immediate Results"  alt="Cultural Fit and Immediate Results">
                    </div>
                    <div class="">

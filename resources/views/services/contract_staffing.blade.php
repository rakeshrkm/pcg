...
<main class="wrapper">
    <section>
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <p class="text-justify"><span class="whatwedotitile">Why Choose Contract Staffing?</span></p>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <p class="text-justify"><span class="whatwedotitile">Our Expertise Across Industries</span></p>
                </div>
            </div>
    ...
    <section class="container">
        <div class="heading-title text-center">
            ...
            <div class="row">
                <div class="col-md-12">
                    <p class="text-justify"><span class="whatwedotitile">Benefits of Our Short-Term Hiring Solutions</span></p>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <ul>
                        ...
                        <li class="text-justify"><span class="whatwedotitile">Seamless Integration:</span> Onboard job-ready candidates for smooth transitions.</li>
                        <li class="text-justify"><span class="whatwedotitile">Risk Mitigation:</span> Reduce overhead and minimize long-term hiring risks. </li>
                    </ul>
    ...
    <section class="container">
        <div class="heading-title text-center">
            <h2>Manpower Recruitment Consultants in India: Connecting Talent with Strategic Opportunity</h2>
        </div>
        <div class="row">
            <div class="col-md-12">
                <p class="text-justify">PCG is among the leading <span class="whatwedotitile">Manpower Recruitment Consultants in India</span> specializing in connecting businesses with exceptional talent. By understanding each client’s specific requirements, we deliver recruitment solutions that foster organisational success.</p>
            </div>
        </div>
    </section>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <ul class="mb-4 mt-4">
                    ...
                    <li class="text-justify"><span class="whatwedotitile">Reduced Turnover Rates:</span> Helping build a stable and productive workforce.</li>
                </ul>
            </div>
            <div class="col-md-6">

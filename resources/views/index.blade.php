        ...
        <div class="row">
            <div class="col-lg-12 text-left ">
                <div class="text-center  p-4">
                    <h1>Best HR Consulting Services India Tailored for Your Business Success</h1>
                </div>
                <div>
                    <img src="{{ asset('assets/img/FCBO.jfif') }}" width="600" height="200" alt="FCBO" title="FCBO">
                </div>


                <br /> <br />

                <p class="text-justify">Prakhar Consulting Group Pvt. Ltd. specializes in bridging the gap between dynamic organizations and talented job seekers across India.</p>
                ...
                <p class="text-justify">At the same time, we are committed to guiding job seekers toward meaningful opportunities that match their skills and aspirations.</p>
                <p class="text-justify">At Prakhar Consulting Group, we understand the rapidly evolving landscape of the job market, particularly in sectors such as:</p>
            </div>
            ...
            <div class="col-lg-12 text-left ">
                <p class="text-justify">We take pride in offering a comprehensive range of HR consulting solutions tailored to meet the unique demands of businesses, whether large corporations or startups.</p>
                <p class="text-justify">Our team of experts leverages years of experience to ensure employers and job seekers benefit from a seamless recruitment process, driving success for all parties involved.</p>
                <p class="text-justify">For emerging businesses, our <span class="whatwedotitile">Recruitment Services</span> are particularly beneficial. As a trusted <span class="whatwedotitile">India HR Consultancy for Startups</span>, we help young and growing companies build a solid workforce that can scale with them. We know the challenges that startups face in their early stages, and we work closely with them to design recruitment strategies that attract top talent while staying aligned with their budget and culture.</p>
                <p class="text-justify">Our solutions go beyond basic recruitment. We offer end-to-end support, including talent acquisition, onboarding, and retention strategies, ensuring organizations have the tools they need to thrive in today's competitive market.</p>
                <p class="text-justify">Whether you're looking for executives, managers, or skilled professionals, Prakhar Consulting Group should be your first priority. We believe the right candidates are the key to any organization's success, and we are here to connect them. Let Prakhar Consulting Group be your trusted partner in shaping a brighter future for your business.</p>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-left ">
                ...
                <p class="text-justify">
                    What makes our recruitment services superior is our commitment to understanding the needs of both employers and students.
                </p>
                <p class="text-justify">
                    We don’t just fill vacancies. We focus on creating a perfect match between companies and graduates, ensuring that new hires are fully prepared to contribute to the organization’s success. This personalized approach has earned us recognition as one of the best recruitment services in India.
                </p>
                <p class="text-justify">
...
<section class="section container" id="ourservices">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-left ">
                <div class="text-center">
                    <h2>We are #1 HR Consulting and Staffing in India</h2>
                </div>
                <p class="text-justify">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-left ">
                ...
                <p class="text-justify">
                    Let Prakhar Consulting Group handle your staffing needs, ensuring that your business stays productive and efficient no matter the circumstances.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-left ">
                ...
                <p class="text-justify">
                    What sets Prakhar Consulting Group apart is our commitment to delivering a seamless recruitment experience. From talent sourcing and screening to placement and onboarding, we handle every step with precision and dedication.
                </p>
                <p class="text-justify">
                    Our proven track record with businesses across IT and Telecom, Retail & E-commerce, and other sectors has earned us a reputation as the best recruitment partner.
                </p>
                <p class="text-justify">
                    Partner with Prakhar Consulting Group and experience recruitment that drives growth, supports business goals, and ensures long-term success. Let us help you build a high-performing team that sets you apart from the competition.
                </p>
            </div>
        </div>
    </div>
...
<section class="section " id="ourservices">
    <div class="container">
        ...
        <p class="key-services text-justify">We deliver state-of-the-art recruitment solutions that match businesses with the right talent. From permanent staffing to training and development, our services are designed to meet diverse hiring needs, ensuring your organization thrives.</p>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-lg-3  pt-3 pt-3 text-center">
                <a href="{{ route('permanentStaffing') }}">
                ...
                <p class="whatwedodecs text-justify" >Prakhar Consulting Group offers tailored permanent staffing solutions, helping you build a loyal, skilled workforce that aligns with your company’s goals.</p>
                <a href="{{ route('permanentStaffing') }}" class="btn btn-success mt-2 text-center"><span class="text-white">View More</span></a>
            </div>
            <div class="col-md-12 col-lg-3  pt-3 pt-3 text-center">
                <a href="{{ route('executiveSearch') }}">
                ...
                <p class="whatwedodecs text-justify">Trust Prakhar Consulting Group’s executive search expertise to connect you with visionary leaders who will drive strategic growth.</p>
                <a href="{{ route('executiveSearch') }}" class="btn btn-success mt-2 text-center"><span class="text-white">View More</span></a>
            </div>
            <div class="col-md-12 col-lg-3 pt-3 pt-3 text-center">
                ...
                <p class="whatwedodecs text-justify">Our leadership hiring services identify and attract high-caliber executives to steer your organization’s long-term success.</p>
                <a href="{{ route('leadershipHiring') }}" class="btn btn-success mt-2 text-center"> <span class="text-white">View More</span></a>
            ...
            <div class="col-md-12 col-lg-3  pt-3 pt-3 text-center">
                ...
                <p class="whatwedodecs text-justify">Prakhar Consulting Group’s precise headhunting services target top talent for critical roles, ensuring a perfect fit for your team.</p>
                <a href="{{ route('headHunting') }}" class="btn btn-success mt-2 text-center"> <span class="text-white">View More</span></a>
            </div>
            ...
            <div class="row mt-5">
                <div class="col-md-12 col-lg-3  pt-3 pt-3 text-center">
                    ...
                    <a href="{{ route('ItNonIthiring') }}" class="btn btn-success mt-2 text-center"> <span class="text-white">View More</span></a>
                </div>

                <div class="col-md-12 col-lg-3  pt-3 pt-3 text-center">
                    <a href="{{ route('temporaryStaffing') }}">
                    ...
                    <p class="whatwedodecs text-justify">Prakhar Consulting Group delivers flexible temporary staffing services for project-based or seasonal workforce requirements, ensuring agility in your operations.</p>
                    <a href="{{ route('temporaryStaffing') }}" class="btn btn-success mt-2 text-center"> <span class="text-white">View More</span></a>
                </div>


                <div class="col-md-12 col-lg-3  pt-3 pt-3 text-center">
                    <a href="{{ route('contractStaffing') }}">
                    ...
                    <a href="{{ route('contractStaffing') }}" class="btn btn-success mt-2 text-center"> <span class="text-white">View More</span></a>
                </div>

                <div class="col-md-12 col-lg-3  pt-3 pt-3 text-center">
                    <a href="{{ route('contractToHire') }}">
                    ...
                    <p class="whatwedodecs text-justify">With C2H hiring, Prakhar Consulting Group allows you to assess talent thoroughly before making a permanent commitment.</p>
                    <a href="{{ route('contractToHire') }}" class="btn btn-success mt-2 text-center"> <span class="text-white">View More</span></a>
                </div>

                <div class="col-md-12 col-lg-3  pt-3 pt-3 text-center">
                    <a href="{{ route('payrollProcessing') }}">
                    ...
                    <a href="{{ route('payrollProcessing') }}" class="btn btn-success mt-2 text-center"> <span class="text-white">View More</span></a>
                </div>

                <div class="col-md-12 col-lg-3  pt-3 pt-3 text-center">
                    <a href="#">
                        <img src="{{ asset('assets/img/mazenet-LMS-service.webp') }}" alt="Campus Recruitment" title="Campus Recruitment" />
                        <h5 class="whatwedotitile">Universities</h5>
                    </a>
                    ...
                    <a href="{{ route('universities') }}" class="btn btn-success mt-2 text-center"> <span class="text-white">View More</span></a>
                </div>
                ...
                {{-- <div class="col-md-12 col-lg-3  pt-3 pt-3 text-center">
                    ...
                    <a href="" class="btn btn-success mt-2 text-center"> <span class="text-white">View More</span></a>
                </div> --}}
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 col-lg-3  pt-3 pt-3 text-center">
                ...
                <a href="{{ route('trainingAndDevelopment') }}" class="btn btn-success mt-2 text-center"> <span class="text-white">View More</span></a>

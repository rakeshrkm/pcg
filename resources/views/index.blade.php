    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-left ">
                ...
                <p class="text-justify">At <span class="whatwedotitile">PCG Global Consulting Pvt. Ltd.,</span> we connect businesses with exceptional talent across India, empowering growth and fostering success.</p>
        ...
        <div class="row mt-4 section">
            ...
            <div class="col-md-12">
                ...
                <p class="text-justify">
                    Whether you’re hiring executives, managers, or skilled professionals, <span class="whatwedotitile">PCG</span> connects you with the talent you need to achieve your goals. With years of expertise and a proven track record, we ensure a seamless recruitment experience tailored to your needs.
                    Let us help you build a brighter future for your business. Partner with PCG, where talent meets opportunity.
                </p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-left ">
                ...
                <p class="text-justify">
                    From pre-placement training and skill assessments to post-placement support, our services ensure you onboard job-ready candidates who can contribute from day one. </p>
                <p class="text-justify">
            ...
            <div class="col-md-12 mt-4">
                <p class="text-justify">By partnering with PCG, you’re not just hiring talent—you’re investing in a future-ready workforce that aligns with your organizational goals.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-left ">
                ...
                <p class="text-justify">PCG Global Consulting is your <span class="whatwedotitile">Best Recruitment Partner in India</span> that is professional in delivering tailored hiring solutions, helping businesses secure top talent that aligns with their values, goals, and culture.</p>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="d-flex justify-content-center gap-8">
                    ...
                    <div class="ml-3">
                        <p><span class="whatwedotitile">End-to-End Recruitment Solutions</span></p>
                        <p> From talent sourcing and screening to onboarding, we manage every step with precision.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="d-flex justify-content-center gap-8">
                    ...
                    <div class="ml-3">
                        <p><span class="whatwedotitile">Customized Approach</span></p>
                        <p> Recruitment strategies aligned with your unique organizational needs.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="d-flex justify-content-center gap-8">
                    ...
                    <div class="ml-3">
                        <p><span class="whatwedotitile">Industry-Specific Expertise</span></p>
                        <p> Proven success in diverse sectors, ensuring a perfect fit for your team.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="d-flex justify-content-center gap-8">
                    ...
                    <div class="ml-3">
                        <p><span class="whatwedotitile">Resource Efficiency</span></p>
                        <p> Save time and costs by accessing our vast network and streamlined processes.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="d-flex justify-content-center gap-8">
                    ...
                    <div class="ml-3">
                        <p><span class="whatwedotitile">Collaborative Partnership</span></p>
                        <p>We work closely with you to exceed expectations and deliver measurable results.</p>
                    </div>
                </div>
            </div>
        </div>
